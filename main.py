...
# РљРѕРѕСЂРґРёРЅР°С‚С‹ РІ СЃРёСЃС‚РµРјРµ РєРѕРѕСЂРґРёРЅР°С‚ EPSG:3857
...
SERVICE = 'https://router.hereapi.com/v8/routes?apiKey=NP-sE4XatQA-6j0I60s7wumcjRIKiIRfnUHmmFI2qGI&transportMode=pedestrian&return=polyline'
...
m = folium.Map(
        ...
        zoom_start=15,
        tiles='https://1.base.maps.ls.hereapi.com/maptile/2.1/maptile/newest/reduced.day/{z}/{x}/{y}/256/png?lg=RU&apiKey=NP-sE4XatQA-6j0I60s7wumcjRIKiIRfnUHmmFI2qGI',
        attr='HERE'
    )
